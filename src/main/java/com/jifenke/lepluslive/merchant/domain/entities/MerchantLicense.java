...
public class MerchantLicense {
  ...
  @ManyToOne
  private MerchantLicenseType
      licenseType;              // 图片类型： 1-营业执照  2-法人身份证 3-税务登记证 4-结算银行卡持有身份证 5-组织结构照 6-结算银行卡
  ...
  public MerchantLicenseType getLicenseType() {
    return licenseType;
  }

  public void setLicenseType(MerchantLicenseType licenseType) {
