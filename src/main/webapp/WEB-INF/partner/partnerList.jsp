                            ...
                            <c:forEach items="${partnerManagers}" var="partnerManager">
                                <tr>
                                    ...
                                    <td class="text-center">￥${partnerManager.availableBalance/100}</td>
                                        ...
                                        <%--</td>--%>
                                    <td>
                                        <button type="button" class="btn btn-default" onclick="cityUserEdit(${partnerManager.partnerManager.partnerId})">账号
                                        </button>
                                        <button type="button" class="btn btn-default" onclick="editCityPartner(${partnerManager.partnerManager.id})">编辑
                                        </button>
                                    </td>
                                </tr>
                            </c:forEach>
