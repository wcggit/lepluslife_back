                ...
                <div class="row" style="margin-bottom: 30px">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <button type="button" class="btn btn-primary "
                                ...
                                onclick="goProductCreatePage()">创建金币商品
                        </button>
                    </div>
                </div>
        ...
        $.ajax({
                   ...
                   success: function (data) {
                       ...
                       for (var i = 0; i < content.length; i++) {
                           ...
                           contentStr +=
                           '<td>￥' + toDecimal(content[i].minScore / 100) + '金币</td>';
                           ...
                           + content[i].id
                           + ')">规格管理</button>'
                           //                           + '<button class="btn btn-primary" onclick="qrCodeManage('
                           //                           + content[i].id
                           //                           + ')">二维码</button>'
                           + '</td></tr>';
...
//        }
    ...
    function specManage(id) {
        location.href = "/manage/gold/specManage?id=" + id;
    }
    function editProduct(id) {
        location.href = "/manage/gold/edit?id=" + id;
    }
    function goProductCreatePage() {
        location.href = "/manage/gold/edit";
    }
