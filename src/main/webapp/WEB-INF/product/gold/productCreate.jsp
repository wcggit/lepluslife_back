...
<div id="content">
    ...
    <div class="m-right">
        <p style="padding-top: 20px">
            <button onclick="javascript:history.go(-1);">返回金币商品列表</button>
            创建金币商品
        </p>
        ...
        <div>
            ...
            <div class="w-prace">
                <span>所需金币：</span>
                <input type="number" placeholder="所需金币" onblur="noNumbers(event,2)"
                       id="productMinScore"
...
<script>
    ...
    $("#save").click(function () {
        ...
        product.thumb = $("#picture").attr("src");
        ...
        $.ajax({
                   type: "post",
                   url: "/manage/gold/save",
                   contentType: "application/json",
                   data: JSON.stringify(productDto),
                   success: function (data) {
                       if (data.status == 200) {
                           location.href = "/manage/gold/product";
                       } else {
                           alert("保存异常");
                       }
                   }
