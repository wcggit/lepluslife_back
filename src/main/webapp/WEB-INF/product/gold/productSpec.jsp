                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <c:forEach items="${productSpecs}" var="productSpec">
                                <tr class="active">
                                    ...
                                    <td class="text-center">${productSpec.minScore/100}</td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="minScore" class="col-sm-3 control-label">所需金币</label>
...
<script>
    ...
    function submit() {
        ...
        productSpec.minPrice = 0;
        productSpec.minScore = Math.round($("#minScore").val() * 100);
        productSpec.toMerchant = 0;
        productSpec.toPartner = 0;
        ...
        $.ajax({
                   ...
                   success: function (data) {
                       setTimeout(function () {
                           location.href =
                           "/manage/gold/specManage?id=${product.id}";
                       }, 0);
                   }
               });
    }
