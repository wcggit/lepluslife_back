...
<script>
    var scoreAAccountDetailCriteria = {};
   var t=$("#changeDate").val();
    if (t!= null && t!= '') {
        var changeDate = t.replace(/-/g, "/");
        scoreAAccountDetailCriteria.changeDate = changeDate;
    }else{
        scoreAAccountDetailCriteria.changeDate = null;
    }
    var flag = true;
    var init1 = 0;
    ...
    $(function () {
        ...
        scoreAAccountDetailCriteria.offset = 1;
        getScoreAAccountDetailByAjax(scoreAAccountDetailCriteria);
    });
    function getScoreAAccountDetailByAjax(scoreAAccountDetailCriteria) {
        scoreAAccountDetailContent.innerHTML = "";
        $.ajax({
                   type: "post",
                   url: "/manage/scoreAAccountDetail",
                   async: false,
                   data: JSON.stringify(scoreAAccountDetailCriteria),
                   ...
                   success: function (data) {
                       ...
                       if (flag) {
                           flag = false;
                           initPage(scoreAAccountDetailCriteria.offset, totalPage);
                       }
                       if (init1) {
    ...
    function initPage(page, totalPage) {
        ...
        $(".tcdPageCode").createPage({
                                         ...
                                         current: page,
                                         backFn: function (p) {
                                             scoreAAccountDetailCriteria.offset = p;
                                             init1 = 0;
                                             getScoreAAccountDetailByAjax(scoreAAccountDetailCriteria);
                                         }
                                     });
    ...
    function searchScoreAAccountDetailByCriteria() {
        scoreAAccountDetailCriteria.offset = 1;
        init1 = 1;
        if ($("#changeProject").val() != 0) {
            scoreAAccountDetailCriteria.changeProject = $("#changeProject").val();
        } else {
            scoreAAccountDetailCriteria.changeProject = null;
        }
    ...
    function exportExcel() {
        ...
        if (scoreAAccountDetailCriteria.changeDate == null) {
            scoreAAccountDetailCriteria.changeDate = null;
        }
        if (scoreAAccountDetailCriteria.changeProject == null) {
            scoreAAccountDetailCriteria.changeProject = null;
        }
        post("/manage/scoreAAccountDetail/export", scoreAAccountDetailCriteria);
    }
    function goback(){
